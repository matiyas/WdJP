...
"""Zaimplementuj na dwa sposoby (rekurencyjnie oraz iteracyjnie) funkcję suma obliczającą sumę
kolejnych liczb naturanlych od 0 do liczby podanej jako parametr wywołania funkcji. Funkcje
powinny wypisywać (w czytelny i zrozumiały sposób) na ekran tablicę zmiennych lokalnych oraz
globalnych.
    - W jaki sposób zmieniają się zmienne lokalne i globalne w zależności od sposobu
      implementacji (rekurencja kontra iteracja)?
    - Czy można zaimplementować iteracyjnie funkcję suma w 2 liniach kodu?"""
