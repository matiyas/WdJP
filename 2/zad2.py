...
"""Zaimplementuj klasę Kolory zawierającą słownik, {...} która jako atrybuty
zwraca wartości HEX odpowiednich kolorów lub AttributeError jeśli kolor nie
jest znany. """


class Kolory:
    _kols = {"Silver": "#C0C0C0", "Gray": "#808080", "Black": "#000000",
